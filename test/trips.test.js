...
describe('Trip API', () => {
  ...
  describe('POST /api/trips', () => {
    it('should create a new trip', async () => {
      ...
      const trip = await get(`SELECT * FROM trips WHERE id = ?`, [response.body.id]);
  ...
  describe('DELETE /api/trips/:id', () => {
    it('should delete trip and cascade to cities', async () => {
      ...
      const deletedTrip = await get(`SELECT * FROM trips WHERE id = ?`, [trip.id]);
      expect(deletedTrip).toBeUndefined();
      
      // Verify cities were cascade deleted
      const cities = await all(`SELECT * FROM cities WHERE trip_id = ?`, [trip.id]);
    ...
    it('should not allow deleting other users trips', async () => {
      ...
      const stillExists = await get(`SELECT * FROM trips WHERE id = ?`, [trip.id]);
